...
using XamarinApp.Helpers.HttpMessageHandlers;
...
namespace XamarinApp
{
    internal class Startup
    {
        ...
        private const string SERVICES_NAMESPACE = "XamarinApp.Services";
        //private const string SINGLE_INSTANCE_SERVICES_NAMESPACE = "ExampleApp.Services.SingleInstance";
        private const string VIEW_MODELS_NAMESPACE = "XamarinApp.ViewModels";
